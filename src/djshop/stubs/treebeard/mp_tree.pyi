...
class MP_Node(Node):
    ...
    @classmethod
    def get_root_nodes(cls) -> MP_NodeQuerySet: ...
    ...
    def get_siblings(self) -> MP_NodeQuerySet: ...

    def get_children(self) -> MP_NodeQuerySet: ...

    def get_next_sibling(self) -> MP_Node | None: ...

    def get_descendants(self) -> MP_NodeQuerySet: ...
    ...
    def add_child(self, **kwargs: Any) -> MP_Node: ...
    ...
    def get_ancestors(self) -> MP_NodeQuerySet: ...
